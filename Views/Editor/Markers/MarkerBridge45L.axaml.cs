...
public partial class MarkerBridge45L : UserControl, IMarkerAngle
{
    public MarkerBridge45L()
    {
    ...
    private void UpdateGeometry(int angle)
    {
        ...
        switch (angle)
        {
            ...
            case 360:
                ...
                // CEZ: Vodorovná koľaj (v jednom kuse)
            ...
            case 45:
                ...
                // Nosníky (šikmé, rovnobežné s TrackLine)
            ...
            case 90:
                ...
                // CEZ: Zvislá koľaj (v jednom kuse)
            ...
            case 180:
                ...
                // Nosníky (vodorovné, prehodené smery)
