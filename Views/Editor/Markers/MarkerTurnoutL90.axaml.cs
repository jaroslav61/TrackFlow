...
public partial class MarkerTurnoutL90 : UserControl, IMarkerAngle
{
    public MarkerTurnoutL90()
    {
    ...
    private void UpdateGeometry(int angle)
    {
        ...
        // Základná geometria: Priama (12,24)-(12,0), Oblúk (12,24)-(0,12)
        ...
        {
            // 0°: Track (12,24)→(12,0), Arc (12,24)→(0,12)
            0   => (new Point(m, f), new Point(m, z), new Point(m, f), new Point(z, m), SweepDirection.CounterClockwise),
            
            // 90°: Track (0,12)→(12,24), Arc (0,12)→(12,0)
            90  => (new Point(z, m), new Point(f, m), new Point(z, m), new Point(m, z), SweepDirection.CounterClockwise),
            
            // 180°: Track (12,0)→(12,24), Arc (12,0.→(24,12)
            180 => (new Point(m, z), new Point(m, f), new Point(m, z), new Point(f, m), SweepDirection.CounterClockwise),
            
            // 270°: Track (24,12)→(0,12), Arc (24,12)→(12,24)
            270 => (new Point(f, m), new Point(z, m), new Point(f, m), new Point(m, f), SweepDirection.CounterClockwise),
            
            _   => (new Point(m, f), new Point(m, z), new Point(m, f), new Point(z, m), SweepDirection.CounterClockwise),
        };
